...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "ผู้ช่วย AI สำหรับเจ้าหน้าที่ภาครัฐ — TaskRath" },
      { property: "og:title", content: "TaskRath — ทาสก์-รัฐ" },
      { name: "twitter:title", content: "TaskRath — ทาสก์-รัฐ" },
      { property: "og:description", content: "ผู้ช่วย AI สำหรับเจ้าหน้าที่ภาครัฐ — TaskRath" },
      { name: "twitter:description", content: "ผู้ช่วย AI สำหรับเจ้าหน้าที่ภาครัฐ — TaskRath" },
