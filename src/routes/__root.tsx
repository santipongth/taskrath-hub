...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TaskRath — ทาสก์-รัฐ" },
      { name: "description", content: "TaskRath (ทาสก์-รัฐ) เป็นผู้ช่วย AI สำหรับเจ้าหน้าที่ภาครัฐไทย — ร่างหนังสือ สรุปประชุม ตอบประชาชน และจัดการงานเอกสารอย่างปลอดภัยและตรวจสอบได้" },
      { property: "og:title", content: "TaskRath — ทาสก์-รัฐ" },
      { name: "twitter:title", content: "TaskRath — ทาสก์-รัฐ" },
      ...
      { property: "og:site_name", content: "TaskRath" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@graph": [
            ...
            {
              "@type": "Service",
              name: "TaskRath AI Assistant",
              serviceType: "AI productivity assistant for government officials",
              provider: { "@type": "Organization", name: "TaskRath" },
              areaServed: "TH",
